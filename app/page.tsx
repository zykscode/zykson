...
const getImages = async (pattern: string) =>
  Promise.all(
    globSync(pattern).map(async (file) => {
      ...
      const {  base64, metadata: { height, width } } = await getPlaiceholder(buffer);
 ...
 return {...post, image:updatedImage}
  ...
  return (
    <div className="page-scroller">
      <CoverWrapper img={Me} />
      <div className="mx-auto max-w-4xl py-6 lg:py-10 page bg-yellow-100 page-has-cover page-has-icon page-has-image-icon full-page index-page">
        <IconHero />
